...
#   https://github.com/hkakitani/SincNet/blob/master/dnn_models.py
# It's slightly modified to handle the current device gracefully
#
# Copyright (c) 2019  Mirco Ravanelli and hkakitani
