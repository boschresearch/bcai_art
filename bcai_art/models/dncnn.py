#
# This source code is from Denoised Smoothing: A Provable Defense for Pretrained Classifiers
...
class DnCNN(nn.Module):
    """
    This code is from https://github.com/microsoft/denoised-smoothing/blob/master/code/archs/dncnn.py
    """
