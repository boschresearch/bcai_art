...
# A slightly modified code borrowed from:
#
# https://github.com/xternalz/WideResNet-pytorch
#
# Modification supports arbitrary number of input channels.
#
...
class WideResNet(nn.Module):
    def __init__(self, num_channels, depth, num_classes, widen_factor=1, scale_factor=1, dropout=0.0):
    ...
    def forward(self, x):
        ...
        out = F.avg_pool2d(out, 8 * self.scale_factor)
